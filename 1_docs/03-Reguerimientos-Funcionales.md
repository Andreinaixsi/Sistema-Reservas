...
| **RF-011** | **Editar Perfil** | Permitir al usuario modificar sus datos personales (nombre, email, contraseña). El administrador puede editar su propio perfil de la misma manera. | Admin/usuario | Media |
| **RF-012** | **Unirse por Código** | El usuario se une de forma autónoma a una organización mediante un código de invitación. | Usuario | Alta |
