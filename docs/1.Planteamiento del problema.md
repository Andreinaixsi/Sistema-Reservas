...
Técnica:
El proyecto incorpora el diseño de un sistema multi-organización (multi-tenant), validación de conflictos de horarios, manejo de roles de usuario y desarrollo de una aplicación web completa con backend y frontend.
